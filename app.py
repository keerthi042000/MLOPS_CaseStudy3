...
from metrics import observe_endpoint, APP_STREAMING_CHUNKS
...
@observe_endpoint('upscale_ui', model_name="FSRCNN")
...
@observe_endpoint('translate_text', model_name="Translator")
